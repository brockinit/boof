...
/* Seed Script */
\COPY block FROM './csv/BLOCK.csv' DELIMITER ',' CSV HEADER;
\COPY conv FROM './csv/conv.csv' DELIMITER ',' CSV HEADER;
\COPY defense FROM './csv/defense.csv' DELIMITER ',' CSV HEADER;
\COPY drive FROM './csv/drive.csv' DELIMITER ',' CSV HEADER;
\COPY fgxp FROM './csv/fgxp.csv' DELIMITER ',' CSV HEADER;
\COPY fumble FROM './csv/fumble.csv' DELIMITER ',' CSV HEADER;
\COPY game FROM './csv/game.csv' DELIMITER ',' CSV HEADER;
\COPY injury FROM './csv/injury.csv' DELIMITER ',' CSV HEADER;
\COPY intercpt FROM './csv/intercpt.csv' DELIMITER ',' CSV HEADER;
\COPY kicker FROM './csv/kicker.csv' DELIMITER ',' CSV HEADER;
\COPY koff FROM './csv/koff.csv' DELIMITER ',' CSV HEADER;
\COPY offense FROM './csv/offense.csv' DELIMITER ',' CSV HEADER;
\COPY oline FROM './csv/oline.csv' DELIMITER ',' CSV HEADER;
\COPY pass FROM './csv/pass.csv' DELIMITER ',' CSV HEADER;
\COPY pbp FROM './csv/pbp.csv' DELIMITER ',' CSV HEADER;
\COPY penalty FROM './csv/penalty.csv' DELIMITER ',' CSV HEADER;
\COPY play FROM './csv/play.csv' DELIMITER ',' CSV HEADER;
\COPY player FROM './csv/player.csv' DELIMITER ',' CSV HEADER;
\COPY punt FROM './csv/punt.csv' DELIMITER ',' CSV HEADER;
\COPY redzone FROM './csv/redzone.csv' DELIMITER ',' CSV HEADER;
\COPY rush FROM './csv/rush.csv' DELIMITER ',' CSV HEADER;
\COPY sack FROM './csv/sack.csv' DELIMITER ',' CSV HEADER;
\COPY safety FROM './csv/safety.csv' DELIMITER ',' CSV HEADER;
\COPY schedule FROM './csv/schedule.csv' DELIMITER ',' CSV HEADER;
\COPY tackle FROM './csv/tackle.csv' DELIMITER ',' CSV HEADER;
\COPY td FROM './csv/td.csv' DELIMITER ',' CSV HEADER;
\COPY team FROM './csv/team.csv' DELIMITER ',' CSV HEADER;
